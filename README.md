...
## color_extra1
Allowed Values: Hex-Value (e.g. `0xFF0000` for the Color Red)
Description: Set the color of the extra1 region (if exist) of the Keyboard

## color_extra2
Allowed Values: Hex-Value (e.g. `0xFF0000` for the Color Red)
Description: Set the color of the extra2 region (if exist) of the Keyboard
...
## extra1
Allowed Values: `0`, `1`
Description: Only get the information, if the keyboard have the extra1 region

## extra2
Allowed Values: `0`, `1`
Description: Only get the information, if the keyboard have the extra2 region
...
## color_extra1
Set the color of the left Keyboard extra1 region (Only when is a supported keyboard)

## color_extra2
Set the color of the left Keyboard extra2 region (Only when is a supported keyboard)
